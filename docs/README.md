...
## Status
All five docs are v1 research-backed drafts, not yet implemented. Known open items are listed at the bottom of each file — review these before/during build, several require product decisions (pricing point, cache-drift thresholds, RC-lookup vendor) rather than further research.
